...
# 1. Description
- This is and end to end machine learning project using Random Forest to assign credit scores to potential customers of a German Bank. It involves supervised learning (using a labeled training set) for classification, where the target is 1 if the customer defaulted on a loan, else 0.
